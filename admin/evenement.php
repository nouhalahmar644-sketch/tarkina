...
<main class="admin-content">
  <div class="content-wrap">
    ...
    <div class="page-body">
      ...
      <!-- TOOLBAR -->
      <div class="toolbar">
        <form method="get" action="evenement.php" class="search-form">
                  ...
                  <td>
                    <div class="actions">
                      <a class="btn-small btn-soft"
                         href="evenement.php?edit=<?php echo (int)$item['id']; ?>&q=<?php echo urlencode($search); ?>&page=<?php echo (int)$page; ?>">Modifier</a>
