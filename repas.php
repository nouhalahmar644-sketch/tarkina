...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($date === '' || $nom === '' || !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $successMsg = $ok ? 'Réservation enregistrée avec succès !' : 'Erreur lors de la réservation.';
    }
}
$desc = trim((string) ($item['description'] ?? 'Savourez un repas maison préparé par une famille locale.'));
?>
<!DOCTYPE html>
<html lang="fr">
<head>
