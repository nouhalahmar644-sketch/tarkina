...
$alreadyReserved = !empty($_SESSION['user_id'])
    && service_user_has_reservation($conn, (int) $_SESSION['user_id'], 'guide', (int) $id);
      ...
      <div class="booking-card">
        ...
        <?php elseif ($alreadyReserved): ?>
          <div class="booking-done">
            ...
            <p class="booking-done__msg">Vous avez déjà réservé ce guide. Retrouvez le détail dans votre espace.</p>
            <a class="booking-done__link" href="mes-reservations.php">Voir mes réservations</a>
          </div>
        <?php else: ?>
